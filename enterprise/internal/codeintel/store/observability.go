...
// FixCommits calls into the inner store and registers the observed results.
func (s *ObservedStore) FixCommits(ctx context.Context, repositoryID int, graph map[string][]string, tipCommit string) (err error) {
